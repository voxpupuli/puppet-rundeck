...
class rundeck (
  ...
  String $vault_keystorage_approle_approleid          = $rundeck::params::vault_keystorage_approle_approleid,
  String $vault_keystorage_approle_secretid           = $rundeck::params::vault_keystorage_approle_secretid,
