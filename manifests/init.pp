...
class rundeck (
  ...
  $rundeck_config_global_web_sec_roles_true = hiera('rundeck::config::global::web::security_roles_enabled', true),
  ...
  validate_bool($rundeck_config_global_web_sec_roles_true)
  validate_array($rundeck_config_global_web_sec_roles)
