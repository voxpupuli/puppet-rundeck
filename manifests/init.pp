...
class rundeck (
  ...
  Stdlib::HTTPSUrl $vault_keystorage_url              = undef,
  String[1] $vault_keystorage_prefix                  = undef,
  String[1] $vault_keystorage_approle_approleid       = undef,
  String[1] $vault_keystorage_approle_secretid        = undef,
  String[1] $vault_keystorage_approle_authmount       = undef,
  String[1] $vault_keystorage_authbackend             = undef,
