...
class rundeck (
  ...
  String[1] $vault_keystorage_prefix                  = $rundeck::params::vault_keystorage_prefix,
  Stdlib::HTTPSUrl $vault_keystorage_url              = $rundeck::params::vault_keystorage_url,
  String[1] $vault_keystorage_approle_approleid       = $rundeck::params::vault_keystorage_approle_approleid,
  String[1] $vault_keystorage_approle_secretid        = $rundeck::params::vault_keystorage_approle_secretid,
  String[1] $vault_keystorage_approle_authmount       = $rundeck::params::vault_keystorage_approle_authmount,
  String[1] $vault_keystorage_authbackend             = $rundeck::params::vault_keystorage_authbackend,
