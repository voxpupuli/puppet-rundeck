...
describe 'rundeck' do
  ...
  describe 'add file-based key storage' do
    ...
    it { should contain_file('/var/lib/rundeck/var/storage/content/keys/foo/bar/public_key.public').with_content(/ssh-rsa AAAAB3rhwL1EoAIuI3hw9wZL146zjPZ6FIqgZKvO24fpZENYnNfmHn5AuOGBXYGTjeVPMzwV7o0mt3iRWk8J9Ujqvzp45IHfEAE7SO2frEIbfALdcwcNggSReQa0du4nd user@localhost/) }
